...
import { KeyUpValidate, validate, validateInput } from '../../assets/scripts/validation'
  ...
  return (
    <form onSubmit={create} className="d-grid mb-5 mt-5 create">
      <h3>Add Product</h3>
                                                                             ...
                                                                             */}
        <input id="name" value={productRequest.name} onChange={(e) => {setProductRequest({...productRequest, name: e.target.value}); KeyUpValidate(e)}} type="text" className="form-control py-2 mb-3" placeholder="Enter name..."/>
        ...
        <input id="price" value={productRequest.price} onChange={(e) => {setProductRequest({...productRequest, price: +e.target.value}); KeyUpValidate(e)}} type="number" className="form-control py-2 mb-3" placeholder="Enter price..."/>
        <p id="demo"></p>
        <input id="rating" value={productRequest.rating} onChange={(e) => {setProductRequest({...productRequest, rating: +e.target.value}); validateInput()}} type="number" max="5" className="form-control py-2 mb-3" placeholder="Enter rating..."/>
