  ...
  return (
    <form onSubmit={create} className="d-grid mb-5 mt-5 create">
      <h3>Add Product</h3>
        ...
        <input value={productRequest.price} onChange={(e) => setProductRequest({...productRequest, price: +e.target.value})} type="text" className="form-control py-2 mb-3" placeholder="Enter price..."/>
        <input value={productRequest.rating} onChange={(e) => setProductRequest({...productRequest, rating: +e.target.value})} type="text" max="5" className="form-control py-2 mb-3" placeholder="Enter rating..."/>
