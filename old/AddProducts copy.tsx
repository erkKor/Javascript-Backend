...
// import { KeyUpValidate, validate, validateInput, validateProducts } from '../../assets/scripts/validation'
...
//                                                                              */}
//         <input id="name" value={productRequest.name} onChange={(e) => {setProductRequest({...productRequest, name: e.target.value}); validateProducts(e)}} type="text" className="form-control py-2 mb-3" placeholder="Enter name..."/>
